	...
	<div>
		...
		>	
			<div class="d-custom-flex align-items-center navbar-left">
				...
				<v-text-field flat solo prepend-icon="ti-search" :placeholder="$t('message.search')" class="search-bar"></v-text-field>
				<div class="mobile-search d-none">
					<v-btn flat icon  small class="mobile-search-btn" @click="toggleSearchForm">
						<!-- <i class="ti-search font-md"><i> -->
					</v-btn>
				</div>
			</div>
			<div class="navbar-right">
				...
				<v-btn icon large @click="toggleFullScreen" class="full-screen ma-0">
					<i class="ti-fullscreen info--text font-lg"></i>
				</v-btn>
